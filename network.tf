module "vpc" {
  ...
  private_subnets = [	"10.96.7.0/27",	"10.96.7.32/27","10.96.2.0/27","10.96.2.32/27" ,"10.96.6.0/25","10.96.6.128/25"]
  private_subnet_names = ["ami-network-tgw-subnet-1","ami-network-tgw-subnet-2","ami-network-trust-subnet-1","ami-network-trust-subnet-2","ami-network-app-subnet-1",	"ami-network-app-subnet-2" ]
